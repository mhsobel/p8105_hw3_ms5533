...
```{r, collapse=TRUE}
# returns the number that is the max, but cannot seem to get the product name involved here
# tried including product_name in a second group_by, but that did not work
instacart_data %>% 
...
table_max = 
  bind_rows(max_baking, max_dog, max_veg) %>% 
  rename(
    Aisle = aisle, 
    Item = product_name, 
    Counts = n
